                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $sql = "CALL MostrarTramites()";
                                $result = $connection->query($sql);
                                
                                if ($result) {
                                    echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0' border='1'>";
                                    echo "<tr>";
                                    echo "<td>Nombres emisor: "."</td>";
                                    echo "<td>Apellidos emisor: ". "</td>";
                                    echo "<td>Nombres receptor: ". "</td>";
                                    echo "<td>Apellidos receptor: ". "</td>";
                                    echo "<td>Nombre del documento: ". "</td>";
                                    echo "<td>Fecha de emisión: ". "</td>";
                                    echo "</tr>";
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>".$row["Nombres_emite"] . "</td>";
                                        echo "<td>".$row["Apellidos_emite"] . "</td>";
                                        echo "<td>".$row["Nombres_recibe"] . "</td>";
                                        echo "<td>".$row["Apellidos_recibe"] . "</td>";
                                    ...
                                    echo "Error al ejecutar el procedimiento almacenado: " . $connection->error;
                                }
